...
The icon that is displayed in front of the entry in the wizard list can be choose from a large amount of available
...
You can select here in which category of the wizard the DCE should appear. Beside a new category
