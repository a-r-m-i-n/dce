...
class ArrayGetIndexViewHelper extends \TYPO3\CMS\Fluid\Core\ViewHelper\AbstractViewHelper
{
    ...
    /**
     * Returns the value of the given index in the given array. To make sure the
     * indexes are numeric the array will be converted. Named array keys will be
     * overwritten by ascending index numbers (starting with 0).
     *
     * @param array $subject The array to get the value of
     * @param int|string $index Index of array. May be int or string.
     *                          Default is zero (0).
