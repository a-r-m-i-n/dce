...
(function() {
  ...
  MT("generator",
     ...
     "  [keyword for]([keyword var] [def codemirrorCycle] [operator =] [number 0]; [variable-2 codemirrorCycle] [operator <] [variable-2 n]; [operator ++][variable-2 codemirrorCycle])",
     "    [keyword yield] [variable-2 codemirrorCycle];",
     "}");
  ...
  MT("indent_for",
     "[keyword for] ([keyword var] [variable codemirrorCycle] [operator =] [number 0];",
     "     [variable codemirrorCycle] [operator <] [number 100];",
     "     [variable codemirrorCycle][operator ++])",
     "  [variable doSomething]([variable codemirrorCycle]);",
     "[keyword debugger];");
