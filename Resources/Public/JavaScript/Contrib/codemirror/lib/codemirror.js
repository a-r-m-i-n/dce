...
(function(mod) {
  ...
  function highlightLine(cm, line, state, forceToEnd) {
    ...
    for (var o = 0; o < cm.state.overlays.length; ++o) {
      ...
      runMode(cm, line.text, overlay.mode, true, function(end, style) {
        var start = i;
        // Ensure there's a token end at the current position, and that codemirrorCycle points at it
        while (at < end) {
          var i_end = st[i];
          if (i_end > end)
  ...
  // text -- codemirrorCycle.e., pressing left should make the cursor go left, even
