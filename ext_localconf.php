...
$boot = function($extensionKey) {
	...
	$extConfiguration = unserialize($GLOBALS['TYPO3_CONF_VARS']['EXT']['extConf'][$extensionKey]); // TODO: Remove?!
	...
	$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/impexp/class.tx_impexp.php']['before_setRelation'][] =
		'EXT:' . $extensionKey . '/Classes/Hooks/tx_dce_impexp.php:tx_dce_impexp->before_setRelation';
	$GLOBALS['TYPO3_CONF_VARS']['SC_OPTIONS']['ext/impexp/class.tx_impexp.php']['before_writeRecordsRecords'][] =
		'EXT:' . $extensionKey . '/Classes/Hooks/tx_dce_impexp.php:tx_dce_impexp->before_writeRecordsRecords';
	...
	$GLOBALS['TYPO3_CONF_VARS'][TYPO3_MODE]['AJAX']['Dce::updateContentElement'] =
		...
		// User conditions
	include_once($extensionPath . 'Classes/UserConditions/user_dceOnCurrentPage.php');
	...
	include_once($extensionPath . 'Classes/UserFunction/class.tx_dce_abstract_formeval.php');
