...
// User conditions
include_once(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('dce') . 'Classes/UserConditions/user_dceOnCurrentPage.php');
...
if (TYPO3_MODE === 'BE') {
	require_once(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath($_EXTKEY).'Classes/UserFunction/class.tx_dce_codemirrorField.php');
	require_once(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath($_EXTKEY) . 'Classes/UserFunction/class.tx_dce_dceFieldCustomLabel.php');
}
...
include_once(\TYPO3\CMS\Core\Utility\ExtensionManagementUtility::extPath('dce') . 'Classes/UserFunction/class.tx_dce_abstract_formeval.php');
