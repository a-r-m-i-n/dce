...
$TCA['tx_dce_domain_model_dce'] = array(
    'ctrl' => array(
		...
		'typeicons' => array(
			'0' => t3lib_extMgm::extRelPath($_EXTKEY) . 'Resources/Public/Icons/tx_dce_domain_model_dce_databased.gif',
			'1' => t3lib_extMgm::extRelPath($_EXTKEY) . 'Resources/Public/Icons/tx_dce_domain_model_dce_filebased.gif',
		),
    ),
);
